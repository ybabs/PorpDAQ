...
#define ADC_BUFFER_LENGTH 16384
...
FATFS FatFSInstance;
uint8_t open_result;
uint8_t wav_write_result = 1;
float32_t freq_component;

// For realFFT calculation
arm_rfft_fast_instance_f32 rfft_instance; // RFFT Instance
...
/**
  * @brief  Function implementing the ADC end of conversion callback.
